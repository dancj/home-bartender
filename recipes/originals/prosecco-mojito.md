...
1. Add mint leaves and simple syrup to a glass and gently muddle — press, don't shred
2. Fill glass with ice
3. Add rum and lime juice, stir briefly
...
- 4 oz simple syrup
- Large handful of mint, muddled in the batch and strained out
