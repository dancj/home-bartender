...
**Method:** Shaken
**Ice:** None (served up) · or rocks in Collins variation
**Difficulty:** Easy
**Flavors:** `CITRUS` `BOTANICAL` `TART`
...
1. Combine gin, lime juice, and simple syrup in a shaker with ice
2. Shake well until chilled
3. Strain into a chilled coupe

*For the Collins variation:* Shake as above, strain into a Collins glass over ice, top with sparkling water and stir gently.
...
- **[Lavender Fields](../../originals/lavender-fields.md)** — a gin sour in the same family, with a floral lavender twist `FLORAL` `CITRUS`
- **[Spice Trade](spice-trade.md)** — another gin sour, with cinnamon syrup and muddled basil `HERBAL` `SPICE`
