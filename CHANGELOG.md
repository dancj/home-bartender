...
- #201 — docs: update CHANGELOG for release 2026.9.25.1 (@app/github-actions)
- #196 — chore(deps): update all non-major dependencies (@app/renovate)
## [2026.9.25.1] - 2026-09-25

- #199 — fix(header): disable scroll anchoring to stop collapsing-header flicker (@dancj)
- #197 — docs: update CHANGELOG for release 2026.9.23.1 (@app/github-actions)
...
- #184 — docs: update CHANGELOG for release 2026.8.18.2 (@app/github-actions)
...
- #81 — feat(families): branching family map with scroll-draw (@dancj)
- #80 — docs: update CHANGELOG for release 2026.6.13.2 (@app/github-actions)
